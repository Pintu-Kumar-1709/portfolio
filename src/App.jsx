        ...
        <div className="App min-h-screen relative">
          ...
          <div className="fixed inset-0 bg-[#0a0a0c]">
            ...
            <div className="absolute inset-0 w-full h-full">
              ...
              <div className="absolute top-0 left-1/4 w-150 h-150 bg-amber-500/2 rounded-full blur-[120px]"></div>
              <div className="absolute bottom-0 right-1/4 w-125 h-125 bg-amber-600/1.5 rounded-full blur-[100px]"></div>
                        ...
                        element={
                          <>
                            ...
                            <MobileSafeSection
                              id="projects"
                              fallback={
                                <FastFallback message="Loading projects..." />
                              }
                            >
                              <Suspense
                                fallback={
                            ...
                            <MobileSafeSection
                              id="tech-stack"
                              fallback={
                                <FastFallback message="Loading tech stack..." />
                              }
                            >
                              <Suspense
                                fallback={
                            ...
                            <MobileSafeSection
                              id="resume"
                              fallback={
                                <FastFallback message="Loading resume..." />
                              }
                            >
                              <Suspense
                                fallback={
