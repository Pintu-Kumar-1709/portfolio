        ...
        <div className="max-w-5xl mx-auto">
          ...
          >
            ...
            <p className="text-neutral-400 text-lg max-w-xl mx-auto">
              Looking for a Full Stack Developer? Let's connect and discuss how
          ...
          <div className="grid lg:grid-cols-5 gap-8">
              ...
              <div className="bg-neutral-900/60 backdrop-blur-sm rounded-2xl p-6 md:p-8 border border-neutral-800">
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <button
                    ...
                    className="w-full py-3.5 px-6 rounded-xl bg-linear-to-r from-amber-500 to-amber-600 text-neutral-900 font-semibold hover:from-amber-400 hover:to-amber-500 transition-all duration-300 flex items-center justify-center gap-2 group disabled:opacity-70 disabled:cursor-not-allowed"
                  >
                    {isSubmitting ? (
                      <>
            ...
            >
              ...
              {/* Availability Status */}
              <div className="bg-linear-to-br from-amber-500/10 to-amber-600/5 rounded-2xl p-6 border border-amber-500/20">
