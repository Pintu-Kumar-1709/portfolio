...
const Footer = () => {
  ...
  const socialLinks = [
    ...
    },
    {
      name: "Email",
      icon: FaEnvelope,
      url: "mailto:mrkumarrr12@gmail.com",
    },
  ];
  ...
  return (
    <footer className="relative">
      ...
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-2/3 max-w-xl h-px bg-linear-to-r from-transparent via-amber-500/30 to-transparent"></div>
      ...
      <div className="py-12 px-6">
        ...
        >
          ...
          {/* Divider */}
          <div className="w-35 h-px bg-yellow-700"></div>
          ...
          <div className="flex flex-col items-center gap-2 text-sm text-neutral-500">
            <span className="flex items-center gap-1.5">
              ...
              by <span className="text-neutral-200">Mr. KumarrR</span>
            </span>
            <span className="text-neutral-500 text-base italic">
