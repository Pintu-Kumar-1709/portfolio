          ...
          >
            ...
            >
              ...
              <div className="relative">
                <motion.div
                  className="absolute inset-0 bg-linear-to-r from-amber-500/60 to-amber-600/40 rounded-xl blur-lg opacity-40 group-hover:opacity-70 transition-opacity duration-300"
                  animate={{
                    scale: [1, 1.1, 1],
                  }}
                  transition={{
                ...
                />
                <div className="relative w-12 h-12 bg-linear-to-br from-neutral-800 to-neutral-900 rounded-xl border border-neutral-700/50 flex items-center justify-center overflow-hidden">
                  <img
                    src="/lolo.jpg"
                    alt="lolo"
              ...
              <div className="hidden sm:block">
                <motion.span className="text-xl font-bold bg-linear-to-r from-neutral-100 via-amber-200 to-neutral-300 bg-clip-text text-transparent">
                  KumarrR.
                </motion.span>
                <span className="text-neutral-500 font-medium text-sm block -mt-1">
                  Developer
                </span>
              </div>
            </motion.button>
              ...
              <div className="relative flex items-center gap-1 p-1.5 bg-neutral-800/50 backdrop-blur-sm rounded-2xl border border-neutral-700/30">
                {navItems.map((item) => (
                  ...
                  >
                    ...
                    {activeSection === item.id && (
                      <motion.div
                        className="absolute inset-0 bg-linear-to-r from-amber-400 to-amber-500 rounded-xl shadow-lg shadow-amber-500/20"
            ...
            <div className="hidden lg:flex items-center gap-3">
              ...
              >
                {/* Button Background */}
                <div className="absolute inset-0 bg-linear-to-r from-amber-500 to-amber-600 transition-all duration-300" />
                <div className="absolute inset-0 bg-linear-to-r from-amber-400 to-amber-500 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
                ...
                {navItems.map((item, index) => (
                  <motion.button
                    ...
                    className={`group w-full flex items-center gap-4 p-4 rounded-2xl transition-all duration-300 ${
                      activeSection === item.id
                        ? "bg-linear-to-r from-amber-500/10 to-amber-600/10 border border-amber-500/20"
                  ...
                  >
                    ...
                    <div
                      className={`w-12 h-12 rounded-xl flex items-center justify-center transition-all duration-300 ${
                        activeSection === item.id
                          ? "bg-linear-to-br from-amber-500 to-amber-600 text-neutral-900 shadow-lg shadow-amber-500/20"
